defmodule RetWeb.Plugs.AddCSP do
  ...
  def generate_csp() do
    ...
    "default-src 'none'; manifest-src #{custom_rules[:manifest_src]} 'self' https://cdn.jsdelivr.net; prefetch-src #{custom_rules[:prefetch_src]}; script-src #{custom_rules[:script_src]} #{
      storage_url
